          ...
          .command(
            ...
            "Install plugins from lockfile or config",
            {
              ...
              "from-config": {
                ...
                default: false,
                describe:
                  "install plugins referenced in quartz.config.yaml instead of lockfile",
              },
              latest: {
                boolean: true,
                default: false,
                describe:
                  "fetch latest version from remote instead of pinned lockfile commit",
              },
              clean: {
                boolean: true,
                default: false,
          ...
          .command(
            ...
            "Add plugins from Git repositories",
            {
              ...
              name: {
                ...
                alias: ["as"],
                describe:
                  "Override the plugin name (for resolving conflicts with duplicate names)",
              },
              subdir: {
                string: true,
                describe:
